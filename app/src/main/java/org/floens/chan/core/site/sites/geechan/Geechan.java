...
public class Geechan extends CommonSite {
    ...
    public static final CommonSiteUrlHandler URL_HANDLER = new CommonSiteUrlHandler() {
        ...
        public HttpUrl getUrl() {
            return HttpUrl.parse("https://www.geechan.org");
        }
    ...
    public void setup() {
        setName("geechan");
        setIcon(SiteIcon.fromFavicon(HttpUrl.parse("https://www.geechan.org/favicon.ico")));
        ...
        setEndpoints(new TinyIBEndpoints(this,
                "https://www.geechan.org",
                "https://www.geechan.org") {

            @Override
            public HttpUrl boards() {
                return new HttpUrl.Builder().scheme("https").host("www.geechan.org").addPathSegment("boards.json").build();
            }
        });
